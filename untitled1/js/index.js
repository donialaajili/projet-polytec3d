...
$(".px-pages .px-page").each(function(i, v) {
  ...
  skewAnimation.fromTo(headingElem, 1, 
                       {css: {top: "-10%", opacity: 0}}, 
                       {css:{top: "0", opacity: 1}})
               .fromTo(descElem, 0.5, 
                       {css: {bottom: "-20%", opacity: 0}}, 
                       {css:{bottom: "0", opacity: 1}}, "-=1")
               .fromTo(hrElem, 1, 
                       {css: {width: "0", opacity: 0}}, 
                       {css:{width: "300px", opacity: 1}}, "-=1");
...
new ScrollMagic.Scene({
      ...
      // .addIndicators() //  indicator Plugin required
      .addTo(controller);
...
// Set Background Images and Color Dynamically
// This is using data-bg-image & data-bg-color to set images and color
